...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Value Plumbing & Electrical Supply",
    phone:     "+27 79 798 6842",
    whatsapp:  "+27 79 798 6842",
    address:   "Marinda Centre Corner 7th Street &, Long Rd, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Value Plumbing & Electrical Supply — Plumber in randburg",
    description: "Value Plumbing & Electrical Supply provides professional plumber in Randburg. 4 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Value Plumbing & Electrical Supply provides fast, reliable plumbing services for homes and businesses across Randburg and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Value Plumbing & Electrical Supply team at work in Randburg",
